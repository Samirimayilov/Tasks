...
SELECT DISTINCT A.* ,B.SAL AS MGR_SAL, A.SAL-B.SAL AS FERQ from emp A, emp B where B.empno=A.mgr AND A.SAL>B.SAL ;

SELECT A.EMPNO,A.ENAME,A.SAL,B.EMPNO MGR_EMPNO, B.ENAME MGR_NAME ,B.SAL MGR_SAL FROM EMP A, EMP B WHERE B.EMPNO = A.MGR AND A.SAL>B.SAL ; 
