...
ALTER TABLE LOAN MODIFY PARTITION BY RANGE(AMOUNT)
(
    PARTITION BRONZ VALUES LESS THAN (7000),
    PARTITION SILVER VALUES LESS THAN (10000),
    PARTITION GOLD VALUES LESS THAN (MAXVALUE)
    );
